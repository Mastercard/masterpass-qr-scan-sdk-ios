...
- In your *Podfile* write the following
  ...
  ```cocoapods
  use_frameworks!
  pod 'MasterpassQRScanSDK', '~> 1.0.6-beta2'
  ```
...
[2]: https://www.github.com/Mastercard/masterpass-qr-scan-sdk-ios/releases/download/1.0.6-beta2/masterpassqrscansdk-framework-ios.zip
